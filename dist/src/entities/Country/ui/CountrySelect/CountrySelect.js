...
export var CountrySelect = memo(function (_a) {
    ...
    return (_jsx(ListBox, { onChange: onChangeHandler, value: value, defaultValue: t('Укажите страну'), label: t('Укажите страну'), items: options, readonly: readonly, direction: "top right" }, void 0));
});
